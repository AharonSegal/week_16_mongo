...
```
.gitignore
app/ [subfolders: 0, files: 4, total files: 4]
    connection.py
    dal.py
    main.py
    routs.py
arc/ [subfolders: 0, files: 4, total files: 4]
    Git_Commands.md
    imports.py
    reading.md
    thinking.md
Dockerfile
employee_data_advanced.json
json_to_mongo.py
README.md
requirements.txt
```
...
**SKIPPED (read error: [WinError 2] The system cannot find the file specified: 'arc/reading.md')**
...
**SKIPPED (read error: [WinError 2] The system cannot find the file specified: 'json_to_mongo.py')**
